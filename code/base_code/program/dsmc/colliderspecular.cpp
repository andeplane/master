...
void ColliderSpecular::collide(Random *rnd, float *v, float *normal_vector, float *tangent_vector_1, float *tangent_vector_2)
{
    // Normal vector
    ...
    float v_normal   = n_x*v[0] + n_y*v[1] + n_z*v[2];
    float v_tangent1 = t1_x*v[0] + t1_y*v[1] + t1_z*v[2];
    float v_tangent2 = t2_x*v[0] + t2_y*v[1] + t2_z*v[2];
