function dsmc(timesteps)
    ...
    [numParticles,p,up,r,v] = createParticles(numParticles,p,up,r,v,sigma,1/4*5000,dt,xrange,yrange,zrange);
    ...
    for i=1:timesteps
       ...
       % sprintf('Moving...')
       [r,v] = mover(r,cells,v,tau,R,L,sigma,numParticles,p,dt,fn); % Move and collide with walls
